...
java -d64 -Xms25G -Xmx40G -Xss25G -cp target/dependency/lucene-core-3.6.2.jar:target/lucene-ngs-1.0-SNAPSHOT.jar tr.byildiz.lucenengs.IndexChromosome -index index_genome -file genome.fasta -kmer 140 -offset 70 -n 12
