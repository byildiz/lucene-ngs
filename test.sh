...
java -d64 -Xms25G -Xmx40G -Xss25G -cp target/lucene-ngs-1.0-SNAPSHOT-jar-with-dependencies.jar tr.byildiz.lucenengs.IndexChromosome -index index_genome -file genome.fasta -kmer 140 -offset 70 -n 12
...
java -d64 -Xms25G -Xmx40G -Xss25G -cp target/lucene-ngs-1.0-SNAPSHOT-jar-with-dependencies.jar tr.byildiz.lucenengs.SearchChromosome -method AnF -index index_genome -query read1.sim -n 12 -e 3 -repeat 1 -results AnF_results.txt -kmer 140
